                ...
                <KeyboardAvoidingView
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <View>
                                <Text style={{...FONTS.h6,color:colors.title,lineHeight:20,marginBottom:4}}>Misellia , 24</Text>
                                <Text style={{...FONTS.fontXs,color:colors.textLight}}>last seen 2m ago</Text>
                            </View>
                        </View>
                        <TouchableOpacity
                            style={{
                        ...
                        >
                            <FontAwesome size={16} color={colors.text} name='video-camera'/>
                        </TouchableOpacity>
                    </View>
                    <View 
                        style={{flex:1}}
